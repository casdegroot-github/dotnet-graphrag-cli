namespace GraphRagCli.Shared.Progress;

public static class ProgressHelper
{
    public static void Render(int current, int total, TimeSpan elapsed, int barWidth, string currentItem)
    {
    ...
    {
        try { Console.Write("\r" + new string(' ', Console.WindowWidth - 1) + "\r"); }
